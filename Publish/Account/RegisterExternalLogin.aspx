<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/SiteBalance.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="Rentoolo.Account.RegisterExternalLogin" %>
