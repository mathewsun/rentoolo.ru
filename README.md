...
Сайт объявлений, аренды/продажи товаров/услуг, аукционов, тендеров, резюме, вакансии, разовые работы.
Также на базе проекта планируем сделать народный шеринг вещей.
И на базе этой платформы сделать рекламную платформу, аналог Яндекс.Директ, чтобы можно было ее встраивать на любой сайт.
